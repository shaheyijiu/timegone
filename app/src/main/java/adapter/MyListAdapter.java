...
public class MyListAdapter extends ArrayAdapter {
    ...
    private int res;
    private  ArrayList<Map<Integer,String>> mList;
    private LinearLayoutManager mLayoutManager;
    private PackageManager pm ;
    private String defaultSplit = "66split66";
    private String[] ImageBox;
    private Drawable[] DrawableBox;
    public MyListAdapter(Context context, int resource,ArrayList<Map<Integer,String>> mList) {
    ...
    private String getSection(int t){
        switch(t){
            case 0:
                return "00:00 - 00:59";
            case 1:
    ...
    private int getKey(Map<Integer,String> map){
        Iterator iterator = map.entrySet().iterator();
        //StringBuilder sb  = new StringBuilder();
        int t = 0;
        while(iterator.hasNext()){
            Map.Entry entry = (Map.Entry)iterator.next();
            t = (Integer)entry.getKey();
        }
        return t;
    }

    private void getValue(Map<Integer,String> map){
        Iterator iterator = map.entrySet().iterator();
        StringBuilder sb  = new StringBuilder();
        while(iterator.hasNext()){
            Map.Entry entry = (Map.Entry)iterator.next();
